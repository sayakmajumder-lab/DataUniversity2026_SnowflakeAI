...
GRANT APPLICATION ROLE SNOWFLAKE."CORTEX-MODEL-ROLE-ALL" TO ROLE ACCOUNTADMIN;
...
CREATE TABLE sales_intelligence.data.sales_conversations (
...
CREATE TABLE sales_intelligence.data.sales_metrics (
    deal_id VARCHAR,
    customer_name VARCHAR,
    deal_value FLOAT,
    close_date DATE,
...
INSERT INTO sales_intelligence.data.sales_metrics
...
CREATE OR REPLACE STAGE sales_intelligence.data.models DIRECTORY = (ENABLE = TRUE);
ALTER ACCOUNT SET CORTEX_ENABLED_CROSS_REGION = 'AWS_US';
SHOW CORTEX SEARCH SERVICES;
-----------------------------------------------------------
--------Now please create the agent using the json file available and please follow instructions in the play book.
--------Once the agent is created, execute below SQL statements.
SHOW AGENTS;
DESCRIBE AGENT SALES_INTELLIGENCE_AGENT;
